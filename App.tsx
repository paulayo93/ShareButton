...
const ShareAnimationConceptScreen = () => {
  const iconState = useSharedValue(1);
  const rippleStateScale = useSharedValue(0);
  const rippleStateOpacity = useSharedValue(0);
  ...
  return (
    <Pressable style={tailwind.style('w-full px-5')}>
      <Animated.View style={tailwind.style('relating z-10')}>
        <Animated.View
          style={[
            tailwind.style(
...
const MainApp = () => {
  return (
    <View style={tailwind.style('flex mt-50 ml-3 mr-3')}>
